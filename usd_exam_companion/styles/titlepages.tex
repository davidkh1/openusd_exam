...
\newcommand{\ColophonPage}{
  ...
  \vspace{\fill}
  Beta edition --- the content is complete and every example is tested, but
  the book is still being revised. Feedback, errata, and the latest version:\\
  \url{https://github.com/davidkh1/openusd_exam}\\[1.2em]
