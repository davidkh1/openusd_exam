...
\begin{Resources}
  \item Tutorials: Inspecting and Authoring Properties; Traversing a Stage
  \item Tooling: \texttt{usdview} (Layer Stack / Composition tabs),
        \texttt{usdcat}
  \item Technical references: USD FAQ ``Over vs Typeless Def'';
        Maximizing USD Performance
  \item OpenUSD API: GetPropertyStack; UsdStage::MuteLayer;
        UsdUtilsCoalescingDiagnosticDelegate; SdfChangeBlock
\end{Resources}
...
of spamming stderr. For time, the \texttt{Trace} module
