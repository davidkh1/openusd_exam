...
\subsection*{Question 4 --- C: 1,500}
500 triangular faces $\times$ 3 indices each $=$ 1,500 entries.
(\texttt{faceVertexCounts} would hold 500 entries, each equal to 3.)

\subsection*{Question 5 --- A, B}
