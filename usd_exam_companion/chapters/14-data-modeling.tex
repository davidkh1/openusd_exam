...
\begin{Resources}
  \item Learn OpenUSD: \href{https://docs.nvidia.com/learn-openusd/latest/stage-setting/index.html}{Setting the Stage};
        \href{https://docs.nvidia.com/learn-openusd/latest/scene-description-blueprints/index.html}{Scene Description Blueprints};
        \href{https://docs.nvidia.com/learn-openusd/latest/beyond-basics/index.html}{Beyond the Basics}
  \item User guide: \href{https://openusd.org/release/user_guides/render_user_guide.html#working-with-primvars}{Rendering --- Working With Primvars}
  \item OpenUSD glossary: \href{https://openusd.org/release/glossary.html#usdglossary-timecode}{TimeCode}; \href{https://openusd.org/release/glossary.html#layer-offset}{Layer Offset}; \href{https://openusd.org/release/glossary.html#list-editing}{List Editing}; \href{https://openusd.org/release/glossary.html#usdglossary-primvar}{Primvar}
  \item OpenUSD API: \href{https://openusd.org/release/api/_usd__page__datatypes.html}{Sdf datatypes};
        \href{https://openusd.org/release/api/class_usd_geom_primvar.html}{UsdGeomPrimvar};
        \href{https://openusd.org/release/api/class_usd_geom_boundable.html}{Boundable};
        \href{https://openusd.org/release/api/class_usd_geom_xform_cache.html}{XformCache};
        \href{https://openusd.org/release/api/class_usd_attribute.html#Usd_AttributeInterpolation}{UsdAttribute interpolation}
\end{Resources}
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] (img)
      {\includegraphics[trim={30 0 0 0}, clip, width=0.92\linewidth]{figures/c14_usdview_props.png}};
