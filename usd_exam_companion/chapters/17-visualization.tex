...
\begin{Resources}
  ...
  \item User guide: \href{https://openusd.org/release/user_guides/render_user_guide.html}{Rendering With USD}
  \item OpenUSD glossary: \href{https://openusd.org/release/glossary.html#usdglossary-gprim}{Gprim}
  \item OpenUSD API: \href{https://openusd.org/release/api/class_usd_shade_material.html}{UsdShadeMaterial};
        \href{https://openusd.org/release/api/class_usd_shade_material_binding_a_p_i.html}{UsdShadeMaterialBindingAPI};
        \href{https://openusd.org/release/api/class_usd_geom_subset.html}{UsdGeomSubset};
        UsdLux (\href{https://openusd.org/release/api/class_usd_lux_light_a_p_i.html}{LightAPI},
        \href{https://openusd.org/release/api/class_usd_lux_shadow_a_p_i.html}{ShadowAPI},
        \href{https://openusd.org/release/api/class_usd_lux_shaping_a_p_i.html}{ShapingAPI},
        \href{https://openusd.org/release/api/class_usd_lux_distant_light.html}{DistantLight});
        \href{https://openusd.org/release/api/usd_geom_page_front.html#UsdGeom_ImageablePurpose}{Imageable Purpose}
\end{Resources}
