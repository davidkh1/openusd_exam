...
\begin{Resources}
  \item Learn OpenUSD: Asset Structure Principles and Content Aggregation;
        Composition Basics; Beyond the Basics
  \item Technical references: Principles of Scalable Asset Structure;
        ASWF Asset Structure Guidelines; USD FAQ ``SubLayers or References?''
  \item OpenUSD glossary: Subcomponent; Crate File Format; Flatten; Edit Target
  \item OpenUSD API: UsdStage::Flatten; SdfChangeBlock; UsdNotice
\end{Resources}
