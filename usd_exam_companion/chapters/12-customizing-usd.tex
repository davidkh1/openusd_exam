...
\begin{Resources}
  ...
  \item OpenUSD tutorial: \href{https://openusd.org/release/tut_generating_new_schema.html}{Generating New Schema Classes (usdGenSchema)}
  \item Whitepaper: \href{https://aousd.org/blog/explainer-series-for-developers-what-are-openusd-schemas/}{What Are OpenUSD Schemas?}
  \item OpenUSD API: \href{https://openusd.org/release/api/class_plug_registry.html#plug_RegisteringPlugins}{PlugRegistry};
        \href{https://openusd.org/release/api/kind_page_front.html}{Kind --- Extensible Categorization};
        \href{https://openusd.org/release/api/ar_page_front.html}{Ar (Asset Resolution)};
        \href{https://openusd.org/release/api/_sdf__page__file_format_plugin.html}{file format plug-ins}
\end{Resources}
...
\noindent \ldots and, continuing in the same \texttt{schema.usda}, the
applied flavor:
...
\texttt{X}?'' --- it maps a logical identifier such as
\texttt{asset://props/chair?\allowbreak version=latest} to a concrete
resolved path,
