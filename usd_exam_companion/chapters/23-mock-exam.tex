...
eliminate wrong options fast. Score yourself with the key on
page~\pageref{ch:mockkey}, which also breaks your result down by domain,
Certiverse-style.
...
\Question{45}
\texttt{CollectionAPI.Apply(prim, "render")} records its application:
\begin{Choices}
...
\begin{Choices}
  ...
  \item B.\ \texttt{faceVertexCounts = [4]} and
        \texttt{faceVertexIndices = [0, 1, 2, 3]} --- OBJ is 1-based, USD
        0-based.
